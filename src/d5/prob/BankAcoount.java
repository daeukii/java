...
//        - 이후 잔고를 정수로 반환한다. */
    ...
    * 3. 출금을 나타내는 `withdraw` 메서드를 가지고 있다.
    ...
    public BankAcoount(String accountNumber, String password) {
    ...
    public static void main(String[] args) {
        BankAcoount account1 = new BankAcoount("asdf", "1234");
        BankAcoount account2 = new BankAcoount("qwer", "1234");
